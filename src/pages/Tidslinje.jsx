...
const NODES = [
  ...
  },
  {
    ...
    acts: [
      ...
      { tag: 'kan', txt: 'Begär serologi för rubella (immunitet kan krävas enligt AFS 2023:2)' },
    ],
    filled: true,
  },
  {
    ...
    t: 'Ledighetsanmälan',
    d: <>Föräldraledighet anmäls senast <strong>3 månader</strong> före start enligt AB 25 — inte 2 månader som i FLL för många andra anställningar. Ange start, slut, omfattning, typ.</>,
    acts: [{ tag: 'bor', txt: 'Skriftligt till chef' }],
  },
  {
    w: 'Dag 60 före BF · A',
    t: 'Graviditetspenning · fysiskt tungt arbete',
    d: <>Om omplacering inte går: 80 % av SGI <strong>från dag 60 t.o.m. dag 11 före BF</strong> (SFB 10 kap 2 §). Dagarna närmast BF täcks istället av föräldrapenning — inte graviditetspenning.</>,
    acts: [{ tag: 'kan', txt: 'Ansök hos Försäkringskassan' }],
  },
  {
    w: 'Dag 60 före BF · B',
